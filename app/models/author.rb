...
class Author < ApplicationRecord
  ...
  # has_many :books, dependent: :restrict_with_exception # causes an ActiveRecord::DeleteRestrictionError exception to be raised if there are any associated records
